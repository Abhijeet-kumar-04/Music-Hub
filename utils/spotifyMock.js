...
const MOCK_PLAYLISTS = [
  {
    ...
    category: 'bollywood',
    tracks: [MOCK_TRACKS[0], MOCK_TRACKS[4]] // Kesariya, Shape of You (acting as bollywood)
  },
  {
    id: 'punjabi_hits',
    name: 'Punjabi Beats',
    ...
    category: 'punjabi',
    tracks: [MOCK_TRACKS[2]] // STAY (placeholder)
  },
  {
    id: 'pop_essentials',
    name: 'Pop Essentials',
...
class SpotifyWebApiMock {
  ...
  async searchPlaylists(query, options = {}) {
    // Return playlists belonging to category or containing query
